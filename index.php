  ...
  <body>
    ...
    <section class="breakfastsec container flex">
      ...
      <div class="rightsidesec">
        <div class="aboutsec">
          <h3 class="tdesign">About Us</h3>
          <div class="aboutbox">
            <img src= alt="">
            <h4>Welcome</h4>
            <p>Welcome to RECIPE RADAR, your ultimate destination for culinary inspiration and delicious recipes!</p>
          </div>
        </div>
    ...
    <section class="subscribe">
      <div class="subscribeinfo">
        ...
        <form action="https://www.youtube.com/@codingwebstudio/codingwebstudio?sub_confirmation=1">
          ...
          <label for="name">RECIPERADAR</label>
